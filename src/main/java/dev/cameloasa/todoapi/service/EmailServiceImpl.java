...
public class EmailServiceImpl {
    ...
    public void sendEmail(EmailDTO dto) {
        ...
        try {
            ResponseEntity<EmailDTO> response = restTemplate.exchange(
    ...
    public void sendTaskCreatedEmail(String email, TaskDTOView task) {
        EmailDTO dto = EmailDTO.builder()
            ...
            .html("<p>Your task <strong>" + task.getTitle() + "</strong> was created successfully.</p>")
            .build();
    ...
    public void sendPasswordResetEmail(String email, String token) {
        EmailDTO dto = EmailDTO.builder()
            ...
            .html("<p>Click the link to reset your password: <a href='https://yourapp/reset?token=" + token + "'>Reset Password</a></p>")
            .build();
