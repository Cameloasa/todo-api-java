...
public class AuthController {
  ...
  // ---------------------------------------------------------
    ...
    public ResponseEntity<RegisterDTOView> register(@RequestBody RegisterDTOForm dto) {
    ...
    // ---------------------------------------------------------
    @GetMapping("/me")
    public ResponseEntity<SessionResponseDTO> me(@RequestHeader("X-Session-Token") String sessionToken) {
