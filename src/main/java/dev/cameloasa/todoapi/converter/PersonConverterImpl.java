...
public class PersonConverterImpl implements PersonConverter {
    ...
    public PersonDTOView toPersonDTOView(Person entity) {
        ...
        return PersonDTOView.builder()
                ...
                .tasks(entity.getTasks() == null ? null :
    ...
    public Person toPersonEntity(PersonDTOForm dtoForm) {
        ...
        return Person.builder()
                ...
                // userEmail does not map here because the email is part of the User entity, not the Person entity. The mapping of userEmail should be handled in the service layer where the User entity is available.
